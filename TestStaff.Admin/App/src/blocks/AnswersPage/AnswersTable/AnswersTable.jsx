                ...
                <Table
                    ...
                    <TableHeader
                        ...
                        <TableRow>
                            ...
                            <TableHeaderColumn style={colButtonWidth}>Корректность</TableHeaderColumn>
                        ...
                        >
                        {
                            this.props.answers.map((item) => (
                                <TableRow key={item.Id}>
                                    ...
                                    <TableRowColumn style={colButtonWidth}>{this.getCorrect(item.Rating)}</TableRowColumn>
