...
class ContestForm extends React.Component {
    ...
    handleSave = () => {
        ...
        const id = this.props.currentCategory ? this.props.currentCategory.Id : null;
    ...
    render() {
        ...
        const title = this.isCreate() ? 'Создание теста' : 'Редактирование теста';
...
const mapStateToProps = function (store) {
    return {
      ...
      //  parentId: tore.ContestFormState.parentId,
